//
//  Southgis_WMTSLayerInfoDelegate.m
//  RTLibrary-ios
//
...
@implementation Southgis_WMTSLayerInfoDelegate
...
- (Southgis_WMTSLayerInfo *)getLayerInfo:(WMTSLayerTypes)wmtsLayerType{
    ...
    //sr
    if (wmtsLayerType < 8) {//sr:webmecator
        ...
        layerInfo.origin = [[AGSPoint alloc]initWithX:X_MIN_2000 y:Y_MAX_2000 spatialReference:[[AGSSpatialReference alloc]initWithWKID:SRID_2000]];
